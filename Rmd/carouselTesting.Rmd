...
lat= 24.9442979;
lon=121.370319
get_layout_g = function(){
 return {"projection":{
 "type":["orthographic"],"rotation":{"lon":lon,"lat":lat,"roll":[0]}},"showland":[true],"showocean":[true],"oceancolor":["#e3f2fd"],"bgcolor":["#00000000"],"landcolor":["#fff8e1"]}
}
